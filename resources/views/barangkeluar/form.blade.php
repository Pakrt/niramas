    ...
    <!-- Content Header (Page header) -->
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-light" style="font-family: Verdana, Geneva, Tahoma, sans-serif">Form Barang Keluar</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-6">
              <div class="card">
                <div class="card-body">
                    <form action="/bkeluar/create" method="POST">
                        @csrf
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" onclick="return confirm('Anda akan mengurangi barang tersebut !!')">Simpan Data</button>
                        </div>
                    </form>
                </div>
              </div>
